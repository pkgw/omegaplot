...
g = omega.Grid (3, 2)
g[0,0] = omega.images.LatexPainter (r'$\frac{2 + \pi}{e^{\pi i} + 1}$')
g[0,1] = omega.images.LatexPainter (r'$2+2=4$')
g[1,0] = omega.images.LatexPainter (r'$\sum_0^{100}x^2 - \cos x$')
g[1,1] = omega.images.LatexPainter (r'$\sum_0^{100}x^2 - \cos x$')
g[2,0] = omega.images.LatexPainter (r'$\sum_0^{100}x^2 - \cos x$')
g[2,1] = omega.images.LatexPainter (r'$\sum_0^{100}x^2 - \cos x$')
g[1,1].setRotation (omega.images.ImagePainter.ROT_CCW90)
g[2,0].setRotation (omega.images.ImagePainter.ROT_CW90)
g[2,1].setRotation (omega.images.ImagePainter.ROT_180)
